...
gh issue create -a "${GITHUB_ACTOR}" --repo "${REPO}" --label release --title "Release v${CANDIDATE_BETA}/v${CANDIDATE_STABLE}" --body "Release v${CANDIDATE_BETA}/v${CANDIDATE_STABLE}
